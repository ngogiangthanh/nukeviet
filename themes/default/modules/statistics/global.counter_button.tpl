<!-- BEGIN: main -->
<button type="button" class="btn btn-default active btn-sm" title="{LANG.viewstats}" data-toggle="ftip" data-target=".view-stats" data-click="y"><em class="fa fa-eye"></em>&nbsp;{LANG.online}: {COUNT_ONLINE}</button>
